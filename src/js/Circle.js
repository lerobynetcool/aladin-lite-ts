...
*/
	...
	Circle.prototype.draw = function(ctx, projection, frame, width, height, largestDim, zoomFactor, noStroke) {
		...
		if (! baseColor && this.overlay) baseColor = this.overlay.color;
		if (! baseColor) baseColor = '#ff0000';

		if (this.isSelected) ctx.strokeStyle = Overlay.increaseBrightness(baseColor, 50);
